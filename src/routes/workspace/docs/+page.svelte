...
<div class="mx-auto w-full max-w-[1180px] px-4 sm:px-6">
	<WorkspaceHeader eyebrow="Workspace" title="Help docs" description="Give customers and developers one clear place to learn how the product works." actionLabel="Write help content" actionHref="/studio" secondaryActionLabel="Open docs" secondaryActionHref={hostedDocsPage.href} secondaryActionExternal />
