<script lang="ts">
	...
	import { ensureMyTenant, renameMyTenant, slugValidationMessage, tenantHost, tenantUrl, type Tenant } from '$lib/tenant';
		...
		<Card padding="lg">
			...
			{:else if tenant}
				...
				<div class="mt-4 grid gap-3">
					...
					<p class="text-[10px] leading-relaxed text-[var(--pc-text-faint)]">Your docs live at <span class="font-mono">{tenant.slug}.productclient.com</span> and your status page at <span class="font-mono">{tenant.slug}.status.productclient.com</span> once status provisioning is active. Roadmap will follow the same pattern.</p>
				</div>
			{:else}
