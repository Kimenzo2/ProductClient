...
export const feedback: FeedbackRecord[] = [
	...
	{			id: 'fb-3',
			title: 'The new voice commands feel natural',
	...
	{			id: 'fb-4',
			title: 'Feedback imports now fail less often',
		...
		{ id: 'road-1', title: 'See what changed between releases', description: 'Compare what changed, what people said, and how each release was received.', status: 'Now', productSlug: 'tetra', productName: 'Tetra', feedbackCount: 14, owner: 'Maya Okafor', area: 'Product updates', confidence: 'High', audience: 'Customer preview', targetWindow: 'This month', deliveryStatus: 'In progress' },
		{ id: 'road-2', title: 'Explain past service problems', description: 'Give customers a clear history of resolved service problems.', status: 'Now', productSlug: 'mossbit', productName: 'Mossbit', feedbackCount: 8, owner: 'Daniel Kim', area: 'Service status', confidence: 'Medium', audience: 'Customer preview', targetWindow: 'This month', deliveryStatus: 'Planned' },
		{ id: 'road-3', title: 'Fix missing answers in help docs', description: 'Turn searches with no clear answer into helpful docs.', status: 'Next', productSlug: 'bento', productName: 'Bento', feedbackCount: 21, owner: 'Nina Volkov', area: 'Help content', confidence: 'Medium', audience: 'Internal', targetWindow: 'Next month', deliveryStatus: 'Planned' },
		{ id: 'road-4', title: 'Organize customer stories', description: 'Group approved customer quotes by use and by who they are for.', status: 'Later', productSlug: 'hearth', productName: 'Hearth', feedbackCount: 5, owner: 'Priya Sharma', area: 'Customer stories', confidence: 'Low', audience: 'Internal', targetWindow: 'Later', deliveryStatus: 'Exploring' },
...
export const incidents: IncidentRecord[] = [
	...
	{ id: 'inc-2', title: 'Some messages arrived late', summary: 'A backlog delayed updates for some teams.', status: 'Monitoring', severity: 'Medium impact', productSlug: 'papercrane', productName: 'Papercrane', startedAt: 'Today, 07:32', owner: 'Amara Mensah', publicPath: hostedStatusPage.href, workspacePath: '/workspace/incidents/inc-2' },
	{ id: 'inc-3', title: 'Some people could not sign in', summary: 'New reports suggest a deployment problem. The team is investigating.', status: 'Investigating', severity: 'High impact', productSlug: 'mossbit', productName: 'Mossbit', startedAt: 'Today, 11:06', owner: 'Daniel Kim', publicPath: hostedStatusPage.href, workspacePath: '/workspace/incidents/inc-3' }
];
...
export const problems: ProblemRecord[] = [
	...
	},
	{
		...
		affectedAudience: 'People trying to use Mossbit today',
		productArea: 'Sign-in',
	...
	},
	{
		...
		affectedAudience: 'Customers learning how to use Bento',
...
export const postIncidentTasks: PostIncidentTask[] = [
	...
	{ id: 'post-incident-5', incidentId: 'inc-1', title: 'Schedule a response debrief', description: 'Invite the responders to review what helped, what slowed the response, and what to change next time.', owner: 'Amara Mensah', status: 'Open', due: 'Next week', phase: 'Reviewing', kind: 'Debrief' }
		...
		{ id: 'proof-4', quote: 'Keeping my drafts saved while I edit is a big improvement for large projects.', name: 'Alex Rivera', role: 'Staff engineer', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop', source: 'Review', status: 'Approved', productSlug: 'inkwell', productName: 'Inkwell', tags: ['Writing', 'Editing'], consent: 'Confirmed', allowedUses: ['Customer stories'], featured: true, outcome: 'Less worry about losing work.' }
	];
...
export const decisionThreads: DecisionThread[] = [
	...
	},
	{
		...
		relations: [
			...
			{ kind: 'Release', title: 'Bento 0.4 update', detail: 'Latest release · 2 hours ago', href: '/workspace/releases/r1', status: 'Live' },
		...
		{ id: 'activity-1', label: 'Release published', detail: 'Bento 0.4 update', time: '2 hours ago', href: '/update/1', kind: 'Release' },
		...
		{ id: 'activity-4', label: 'Customer story approved', detail: 'The new feedback imports are exactly what our team needed.', time: 'Yesterday', href: '/workspace/proof', kind: 'Proof' }
	];
