	...
	<div class="auth-frame">
		...
		<aside class="auth-story" aria-labelledby="auth-story-title">
			...
			<div class="auth-story-copy">
				<p class="auth-kicker">{storyKicker}</p>
...
<style>
	...
	.auth-story-copy { max-width: 470px; margin-inline: auto; padding-top: 28px; }.auth-kicker { margin: 0 0 12px; color: var(--pc-accent-light); font-size: 10px; font-weight: 600; letter-spacing: .14em; text-transform: uppercase; }.auth-story-copy h2 { max-width: 12ch; margin: 0; color: var(--pc-text); font-size: clamp(25px, 3vw, 39px); font-weight: 500; line-height: 1.06; letter-spacing: -.055em; }.auth-story-copy p:last-child { max-width: 43ch; margin: 15px 0 0; color: var(--pc-text-muted); font-size: 13px; line-height: 1.65; }
